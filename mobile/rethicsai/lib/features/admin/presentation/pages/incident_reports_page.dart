...
class _IncidentReportsPageState extends State<IncidentReportsPage> with TickerProviderStateMixin {
  ...
  Future<void> _downloadAsJSON() async {
    try {
      final reportData = {
        'report_info': {
          'title': 'Rethicssec Incident Reports',
  ...
  Future<void> _downloadAsSummary() async {
    try {
      ...
      buffer.writeln('Generated by Rethicssec Incident Management System');
  ...
  Future<void> _saveAndShareFile(String content, String filename, String mimeType) async {
    try {
      ...
      await Share.shareXFiles(
        ...
        subject: 'Rethicssec Incident Reports',
          ...
          pw.Container(
            ...
            child: pw.Column(
              children: [
                ...
                pw.SizedBox(height: 4),
                pw.Text(
                  'RethicsAI Admin Dashboard • Confidential Document',
