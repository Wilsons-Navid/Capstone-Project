...
Usage:
    HF_TOKEN=hf_xxx python serve/deploy_hf_space.py            # from ml/
    HF_TOKEN=hf_xxx python serve/deploy_hf_space.py my-space-name
"""
...
uploads = {
    "Dockerfile": ROOT / "serve" / "Dockerfile",
    "serve/app.py": ROOT / "serve" / "app.py",
    "serve/requirements.txt": ROOT / "serve" / "requirements.txt",
    "src/embed_model.py": ROOT / "src" / "embed_model.py",
    "src/demo_model.py": ROOT / "src" / "demo_model.py",
    "models/embed_models.joblib": ROOT / "models" / "embed_models.joblib",
}
