...
Usage (from ml/):
    HF_TOKEN=hf_xxx python final_serve/deploy_hf_space_v2.py [space-name]
"""
...
uploads = {
    "Dockerfile": ROOT / "final_serve" / "Dockerfile",
    "final_serve/app.py": ROOT / "final_serve" / "app.py",
    "final_serve/requirements.txt": ROOT / "final_serve" / "requirements.txt",
    # the model lives with its notebook; upload it into final_serve/ in the Space
    "final_serve/scam_tfidf_v2.joblib": ROOT / "notebooks" / "final_model" / "scam_tfidf_v2.joblib",
}
